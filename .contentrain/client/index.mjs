...
import _catalogCollectionEn from './data/catalog-collection.en.mjs'
...
import _productEn from './data/product.en.mjs'
import _promoCampaignEn from './data/promo-campaign.en.mjs'
...
const _relationMeta = {
  'catalog-collection': {
    'featured_products': { target: 'product', multi: true },
  },
}

const _collectionRegistry = {
  'catalog-collection': new Map([
    ['en', _catalogCollectionEn],
  ]),
  'faq-item': new Map([
    ['en', _faqItemEn],
  ]),
